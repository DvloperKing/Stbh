...
CREATE TABLE materiales (
  id INT AUTO_INCREMENT PRIMARY KEY,
  id_teacher_subject INT NOT NULL,
  nombre_archivo VARCHAR(255) NOT NULL,
  ruta_archivo TEXT NOT NULL,
  fecha_subida DATETIME DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (id_teacher_subject) REFERENCES teacher_subjects(id)
);
...
-- consultas y inserts didactico
select * from materiales;
INSERT INTO materiales (id_teacher_subject, nombre_archivo, ruta_archivo, fecha_subida) VALUES
(1, 'Temario_Matematicas.pdf', 'materiales/1/Temario_Matematicas.pdf', '2025-05-01 10:00:00'),
(1, 'Guia_Algebra.pdf', 'materiales/1/Guia_Algebra.pdf', '2025-05-01 11:00:00'),
(2, 'Ejercicios_Quimica.docx', 'materiales/2/Ejercicios_Quimica.docx', '2025-05-01 09:30:00'),
(2, 'Practica_Laboratorio.zip', 'materiales/2/Practica_Laboratorio.zip', '2025-05-01 12:15:00'),
(3, 'Lectura_Historia.pdf', 'materiales/3/Lectura_Historia.pdf', '2025-05-01 08:45:00');
