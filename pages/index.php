            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8" >
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient text-center">Bienvenido!</h3>
                  <p class="mb-0 text-center">Seleccione su Perfil</p>
                </div>
                <div class="card-body">
                  <form role="form">
                    <div class="text-center">
                      <button onclick="location.href='./admin.php'" Id="btn__Admin" class="btn bg-gradient-info w-100 mt-4 mb-0">Administración</button>
                    </div>
                    <div class="text-center">
                      <button onclick="location.href='./docente.php'" class="btn bg-gradient-info w-100 mt-4 mb-0">Docente</button>
                    </div>
                    <div class="text-center">
                      <button onclick="location.href='./alumno.php'" class="btn bg-gradient-info w-100 mt-4 mb-0">Alumno</button>
                    </div>
                  </form>
                </div> 
              </div>
